       ...
       <div class="footer">
		  ...
		  <div class="row">
			   <div class="col-lg-6">
			   	...
			   	<p>KSM  is a registerd online bus booking website by the Our  team.Any issues can be brought up to the judicial of the District & Sessions Court, Gwalior.   </p>
			    <ul class="links">
			 ...
			 <div class="footer-bottom">
			 	...
			 	<div class="copy-right">
			 		<p>KSM booking Copyright &copy; 2019-2022  all right reserved. </p>
			 	</div>
