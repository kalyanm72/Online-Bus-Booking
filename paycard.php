...
<br><br><br><br><br><br><br><br><br><br>
  ...
  <span class='footer-arrow'></span>
       <div class='footer'>
		  ...
		  <div class='row'>
			   <div class='col-lg-6'>
			   	<h2>About KSM booking Booking</h2>
			   	<p>KSM booking  is a registerd online bus booking website by the Our  team. Any issues can be brought up to the judicial of the District & Sessions Court, Gwalior.   </p>
			    <ul class='links'>
			 ...
			 <div class='footer-bottom'>
			 	...
			 	<div class='copy-right'>
			 		<p>KSM booking booking Copyright &copy; 2019-2022  all right reserved. </p>
			 	</div>
